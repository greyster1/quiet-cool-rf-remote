...
const char* QuietCool::speed_settings[] = {
    ...
    "00001010101101010101010101010101010101010101010101010101010101010101010101000101101110101000000011011001011000000000101100110110100100000001000000000", // LOFF
};
...
void QuietCool::sendPacket(const char *data, uint8_t len) {
    for (int i = 0; i < 3; i++) {
        ...
        delay(18); //changed from 18 (grok said 34)
    }
}
